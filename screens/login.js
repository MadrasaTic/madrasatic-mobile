  ...
  useEffect(() => {
    Linking.addEventListener("url", (url) => {
      ...
      if (uri) {
        ...
        axios
          .get("http://madrasatic.tech/api/user", {
          ...
          .then((res) => {
            ...
            dispatch(
              setUserPicture(
                "http://madrasatic.tech/storage/images/" +
                  res.data.user_information.avatar_path
              )
            );
          })
          .catch((err) => {
    ...
    >
      ...
      <View style={styles.content}>
        ...
        <Body style={styles.description}>
          MadrasaTic est une plateforme qui permet de signaler facilement un
          problème sans se soucier de l'autorité responsable de sa résolution.
        </Body>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Linking.openURL("http://madrasatic.tech/api/login/google")
          }
        >
        ...
        <Body style={styles.copyright}>© 2022 Quality Softwares, Inc</Body>
      </View>
